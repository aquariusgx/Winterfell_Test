...
class AchievementCellLoader : public CCNodeLoader //注意：CCTableViewCell这里是使用CCNodeLoader，不是CCLayerLoader
{
public:
    
    static CCNode* createCell() {
        CCNodeLoaderLibrary::sharedCCNodeLoaderLibrary()->registerCCNodeLoader("AchievementCell", AchievementCellLoader::loader());
